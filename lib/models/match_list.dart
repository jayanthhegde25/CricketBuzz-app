...
MatchList? matchListFromJson(String str) {
  try {
    log('entered');
  return MatchList.fromJson(json.decode(str));
} catch (e) {
  // TODO
...
class Match {
  ...
  return Match(
    ...
    matchScore: json["matchScore"] != null ? MatchScore.fromJson(json["matchScore"]) : null,
      );
    }
...
class VenueInfo {
    ...
    factory VenueInfo.fromJson(Map<String, dynamic> json) => VenueInfo(
        ...
        ground: json["ground"],
        city: json["city"],
        timezone: json["timezone"] != null ?timezoneValues.map[json["timezone"]]:null,
...
class MatchScore {
    ...
    factory MatchScore.fromJson(Map<String, dynamic> json) => MatchScore(
        ...
        team2Score: json["team2Score"] != null ? TeamScore.fromJson(json["team2Score"]):null,
    );
...
class Inngs {
    ...
    factory Inngs.fromJson(Map<String, dynamic> json) => Inngs(
        ...
        overs: json["overs"] !=null? json["overs"]?.toDouble():0.0,
